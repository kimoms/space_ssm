			...
			<div class="mainbar">
				<div class="page-head">
					...
					<div class="bread-crumb pull-right">
						...
						<a href="#" class="bread-current">发布活动</a>
					</div>
										...
										<div class="padd">
											...
											<form class="form-horizontal" role="form" >
												...
												<div class="form-group">
													...
													<div class="col-lg-8">
														<input id="title" type="text" class="form-control" placeholder="活动标题" required="required">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-8">
														<textarea id="introduce" class="form-control" rows="3" placeholder="活动简介" required="required"></textarea>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3 col-md-4">
														<input id="startTime" type="datetime-local" class="form-control" placeholder="活动开始时间" required="required">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-4 control-label" >结束时间</label>
													<div class="col-lg-3 col-md-4">
														<input id="endTime" type="datetime-local" class="form-control" placeholder="活动结束时间" required="required">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-2 col-md-2">
														<input id="tickets" type="number" class="form-control" value="0">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3 col-md-3" style="margin-bottom: 10px;">
														<select id="buildingType" class="form-control" required="required" onchange="changeBuildingType()">
													...
													<div class="col-lg-3 col-md-3" style="margin-bottom: 10px;">
														<select id="buildingId" class="form-control" required="required" onchange="changeBuildingId()">
															<option>选择建筑</option>
															
														</select>
													</div>
													<div class="col-lg-3 col-md-3" style="margin-bottom: 10px;">
														<select id="roomId" class="form-control" required="required">
															<option>选择房间</option>
		...
		$(document).ready(function() {
			...
			$("#submit").click(function() {
				...
				$.ajax({
					...
					data: JSON.stringify({title: title, introduce: introduce, 
						startTime: startTime, endTime: endTime, 
						tickets: tickets, roomId: roomId,
						imgPath: imgPath, detail: detail,
						}),
			...
			success: function(data) {
				...
				if (obj.length == 0) {
					...
					for(var n=0; n<obj.length; n++){
						buildingId.options.add(new Option(obj[n].buiName, obj[n].buiId)); 
					} 
				}
			},
			error: function(msg) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (obj.length == 0) {
					...
					for(var n=0; n<obj.length; n++){
						roomId.options.add(new Option(obj[n].roomNumber, obj[n].roomId)); 
					} 
				}
			},
			error: function(msg) {
