	...
	<div class="container" >
		<div class="row ">
			<div class="col-xs-12 col-sm-9">
				...
				<div class="ss2_wrapper row animated jello" >
                    ...
                    <div id="slideshow_2" class="slideshow">
                        <div class="slideshow_item">
                            <div class="image">
                                <a href="#"><img src="${ctx }/images/c3f83903c51244499fc40a5b8ca8fd1a.jpg"  height="400" /></a>
                            </div>
                            <div class="data">
                                <h4>活动预告</h4>
                                <p>即将开始的活动，快来参与！</p>
                        ...
                        <div class="slideshow_item">
                            <div class="image">
                                <a href="${ctx }/act/foredetail/${act.actId}"><img src="${ctx }${act.actImgPath}" height="400" /></a>
                            </div>
                            <div class="data">
                                <h4>${act.actTitle }</h4>
				...
				<!-- 所有活动 -->
				<span class="pull-right "><a href="${ctx}/act/actList" class="view-all-act">更多》</a></span>
				<hr>
					...
					<c:choose>  
				        <c:when test="${status.index % 2 == 0}">  
				             <section class="animated bounceInLeft">
								<div class="row">
									<div class="col-md-6 ">
										<img src="${ctx }${act.actImgPath}" class="img-responsive " alt=" " />
									</div>
									<div class="col-md-6 ">
										<h2 class="act-title">${act.actTitle }</h2>
										<p class="act-intro"><span class="glyphicon glyphicon-tree-conifer tree-icon "></span>${act.actIntroduce }</p>
										<a class="btn btn-default view-more" href="${ctx }/act/detail/${act.actId}" role="button">查看详情&raquo;</a>
									</div>
								</div>
							</section>
				        </c:when>  
