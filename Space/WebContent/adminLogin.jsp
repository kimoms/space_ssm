...
<head>
	...
	<link rel="stylesheet" href="admin/style/bootstrap.css" />
...
<body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			...
			<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="admin/login" method="post">
			...
			<div class="text-center">
				<a href="create-account.html" class="templatemo-create-new">首页<i class="fa fa-arrow-circle-o-right"></i></a>
			</div>
		</div>
	</div>
</body>
